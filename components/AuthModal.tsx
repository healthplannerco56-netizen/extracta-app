    ...
    <div style={overlayStyle}>
      <div style={cardStyle}>
        ...
        <button
          ...
          style={{ width: '100%', padding: '12px', background: 'transparent', border: '1px solid #333', borderRadius: '4px', color: '#fff', fontSize: '12px', fontFamily: 'var(--mono)', letterSpacing: '0.05em', cursor: 'pointer', marginBottom: '20px' }}
        >
